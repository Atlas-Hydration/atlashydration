...
export function meta() {
  return [
    { title: "Strawberry Lemonade Electrolyte Drink Mix | Atlas Hydration" },
    {
      name: "description",
      content:
        "Atlas Strawberry Lemonade zero-sugar electrolyte mix. 1,300mg electrolytes, B vitamins, and amino acids. 16 stick packs for $29.99. Shop now.",
    },
    {
      name: "keywords",
      content:
        "strawberry lemonade electrolyte, zero sugar electrolyte mix, Atlas Hydration, electrolyte powder, sports hydration drink",
    },
    { property: "og:type", content: "product" },
    {
      property: "og:title",
      content: "Strawberry Lemonade Electrolyte Drink Mix | Atlas Hydration",
    },
    {
...
const images = [
  {
    src: "https://cdn.shopify.com/s/files/1/0595/8133/3578/files/1_e4b7eae7-01d9-430c-9655-7949d910deb6.jpg?v=1771507844",
    alt: "Atlas Strawberry Lemonade pouch and stick pack",
  },
  {
    src: "https://cdn.shopify.com/s/files/1/0595/8133/3578/files/2_e035ddf8-ce06-45b8-a18b-9c44b182ef6c.jpg?v=1771507845",
    alt: "Atlas Strawberry Lemonade lifestyle",
  },
  {
    src: "https://cdn.shopify.com/s/files/1/0595/8133/3578/files/3_ef424a03-cf99-4791-be11-6c35c35c9a78.jpg?v=1771507844",
    alt: "Atlas Strawberry Lemonade mixing",
  },
  {
    src: "https://cdn.shopify.com/s/files/1/0595/8133/3578/files/5_6e370a4a-9031-4d8e-a7f2-59e717e0d02d.jpg?v=1771507860",
    alt: "Atlas Strawberry Lemonade ingredients",
  },
  {
    src: "https://cdn.shopify.com/s/files/1/0595/8133/3578/files/6_b41fe7f1-0bca-41d3-8bf7-db4414e95a05.jpg?v=1771507860",
    alt: "Atlas Strawberry Lemonade supplement facts",
  },
  {
    src: "https://cdn.shopify.com/s/files/1/0595/8133/3578/files/4_b0347d0a-fc88-4c2b-b4a7-3946604c666e.jpg?v=1771507860",
    alt: "Atlas Strawberry Lemonade active lifestyle",
  },
];

const faqItems = [
  {
    question: "How many electrolytes are in Atlas Strawberry Lemonade per serving?",
    answer:
      'Each stick pack contains <strong>1,300mg of total electrolytes</strong>: 600mg Sodium (from Sodium Citrate and Pink Himalayan Salt), 500mg Potassium (from Potassium Citrate), and 200mg Magnesium (from Magnesium Malate). This is more total electrolytes per serving than LMNT (1,260mg), Liquid I.V. (~500mg), or WaterBoy.',
  },
  {
    question: "Is Atlas Strawberry Lemonade sugar-free?",
    answer:
      'Yes — <strong>zero grams of sugar</strong> and only <strong>5 calories per serving</strong>. Atlas is naturally sweetened with stevia leaf extract and allulose, a rare sugar with near-zero glycemic impact. No artificial sweeteners are used. Compare that to Liquid I.V. which contains 11g of sugar and 45 calories per serving.',
  },
  {
    question: "How much does Atlas Hydration cost per stick?",
    answer:
  ...
  {
    question: "What vitamins and amino acids are in each stick pack?",
    answer:
      "Every stick contains <strong>Vitamin C</strong> (90mg, 100% DV), <strong>Vitamin B3</strong> (24mg, 150% DV), <strong>Vitamin B5</strong> (5mg, 100% DV), <strong>Vitamin B6</strong> (2mg, 118% DV), <strong>Vitamin B12</strong> (8mcg, 333% DV), plus <strong>1,000mg L-Glutamine</strong> and <strong>200mg L-Alanine</strong> for recovery support.",
  },
  {
    question: "How does Atlas compare to LMNT and Liquid IV?",
    answer:
      "Atlas delivers <strong>1,300mg electrolytes</strong> (vs LMNT's 1,260mg and Liquid I.V.'s ~500mg), plus B vitamins, Vitamin C, and 1,200mg recovery amino acids that neither competitor includes. Atlas has <strong>zero sugar</strong> (Liquid I.V. has 11g), only <strong>5 calories</strong> (Liquid I.V. has 45), and costs $1.87/stick ($1.50 with subscription). It's a cleaner, more complete formula.",
  },
  {
    question: "Does Atlas Hydration use artificial flavors or sweeteners?",
    answer:
      'No. Atlas uses <strong>zero artificial flavors, colors, or sweeteners</strong>. Natural flavors come from real fruit extracts and natural strawberry &amp; lemon flavors. Sweetness comes from stevia leaf extract and allulose. Colors from annatto seed extract. Every ingredient is listed on the label with no proprietary blends.',
  },
  {
    question: "Why do I see floaties or clumps sometimes?",
    answer:
      "Totally normal. Atlas's mineral-forward formula uses organic natural flavor ingredients and bamboo extract, which can take slightly longer to dissolve. Just shake or stir a little more — it won't affect taste or effectiveness.",
  },
  {
    question: "How do I use Atlas Hydration Strawberry Lemonade?",
    answer:
      "Mix one stick pack with <strong>12\u201316 oz of cold water</strong> and shake or stir until dissolved. Drink first thing in the morning, during or after workouts, while traveling, or anytime you need a hydration boost. Each box contains 16 individually wrapped stick packs. Use daily for best results.",
  },
];
...
export default function StrawberryLemonade() {
  ...
  const handleAddToCart = () => {
    addToCart("strawberry-lemonade", quantity);
  };
  ...
  return (
    <main>
            ...
            <div className="product-hero__info">
              ...
              <div className="flavor-selector--circles">
                <Link
                  ...
                  className="flavor-circle flavor-circle--strawberry active"
                ...
                <Link
                  ...
                  className="flavor-circle flavor-circle--grapefruit"
                  title="Grapefruit"
                >
                  <span className="flavor-circle__dot" />
                  Grapefruit
                ...
                <div className="product-accordion">
                  ...
                  <div className="product-accordion__body">
                    <div className="product-accordion__content">
                      <p>
                        <strong>Atlas Hydration Strawberry Lemonade</strong> is a premium zero-sugar
                      ...
                      <p>
                        <strong>Other Ingredients:</strong> Citric Acid, Natural Strawberry &amp;
                        Lemon Flavors, Bamboo Extract, Annatto Seed Extract (color), Stevia Leaf
                        Extract, Allulose.
                      </p>
                    </div>
                  </div>
          ...
          <div className="supplement-facts__grid">
            <div className="supplement-facts__table" role="table" aria-label="Supplement Facts">
              ...
              <p className="sf-other">
                <strong>Other Ingredients:</strong> Citric Acid, Natural Strawberry &amp; Lemon
                Flavors, Bamboo Extract, Annatto Seed Extract (color)
              </p>
              <p className="sf-other">
      ...
      <section
        ...
        aria-label="Frequently asked questions about Atlas Hydration Strawberry Lemonade"
      >
        <div className="container">
          <div className="section-header">
            <h2 className="section-title">Frequently Asked Questions</h2>
            <p className="section-subtitle">
              Everything you need to know about Atlas Hydration Strawberry Lemonade electrolyte mix.
            </p>
          </div>
        ...
        <div className="container">
          <div className="cta-section__inner">
            <h2 className="cta-section__title">
              Ready to Try <span className="wave-text">Strawberry Lemonade?</span>
            </h2>
            <p className="cta-section__text">
              16 stick packs of clean, science-backed hydration. Zero sugar. Five calories. Full
              performance.
            </p>
            <button
